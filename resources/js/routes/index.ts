 ...
 * @route '/log-off'
 */
export const logOff = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: logOff.url(options),
    method: 'post',
})
 ...
 * @route '/log-off'
 */
logOff.url = (options?: RouteQueryOptions) => {
    return logOff.definition.url + queryParams(options)
}
 ...
 * @route '/log-off'
 */
logOff.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: logOff.url(options),
    method: 'post',
})
 ...
 * @route '/log-off'
 */
    const logOffForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: logOff.url(options),
        method: 'post',
    })
 ...
 * @route '/log-off'
 */
        logOffForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: logOff.url(options),
            method: 'post',
        })
    
    logOff.form = logOffForm